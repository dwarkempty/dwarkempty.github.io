...
【公元2024年7月7日，即新纪元元年1月1日，新纪元人类联合政府，正式成立。】`,
  skills: `核心机制：【绚明印记】
一种可叠加的元素持续伤害（DoT）。
每层每回合对目标造成「攻击力×70%」的元素伤害。
最多叠加8层，超出上限时自动引爆超出的层数，每引爆1层造成「攻击力×100%」的元素伤害。
被动技能：绚明本源
阿特亚天生与万物属性共鸣。
主动造成伤害时，为目标额外附加1层【绚明印记】。
在附加【绚明印记】的瞬间，立即触发一次印记伤害，并提升自身25%元素伤害（最多叠加3层），同时回复自身5点终结能量，此效果每回合回复的终结能量最多20点。
敌方每有一层【绚明印记】，受到的伤害+2.5%。
将阿特亚造成的所有属性增伤转换为全元素增伤。
普攻：绚光初绽（消耗0技能点，冷却1回合）
“微光乍现，万物应和。”
对指定敌人造成130%攻击力的元素伤害，有50%的概率附加1层【绚明印记】；同时对周围两名敌人造成80%攻击力的元素伤害，有25%的概率附加1层【绚明印记】。
战技：万象绚华（消耗1技能点，冷却1回合）
“看啊，指尖初绽，绚烂华章。”
对敌方全体造成220%攻击力的元素伤害，为每个敌人附加3层【绚明印记】。
若任意敌人的【绚明印记】层数≥5，则全体敌人额外获得【元素凝视】：减少目标15%的防御，持续2回合，不可叠加。
战技：绚律易质（消耗1技能点，无冷却）
“吾改万物之性，唯绚明永恒。”
对指定敌人造成400%攻击力的元素伤害，使其在本回合内受到的【绚明印记】伤害提升100%（不可叠加）。
立即引爆敌人所有【绚明印记】，每引爆1层额外造成攻击力×100%的元素伤害。
引爆后回复20点终结能量，并使自身攻击力提升30%，持续2回合（不可叠加）。
终结技：万般绚明（消耗100点终结能量）
“这一瞬，世间万物皆为吾之烟火。”
对敌方全体造成750%攻击力的元素伤害 + 全场所有敌人【绚明印记】层数×200%的毁灭性元素伤害。
使敌方全体进入【绚明崩解】状态：后续3回合，每回合自动触发一次等同于引爆前该敌人身上印记层数的伤害，此伤害无视防御，且无法被驱散。
终结技结束后，阿特亚进入【神子永辉】状态：攻击力增加60%，所有伤害均无视防御，【绚明印记】附加层数+1（持续2回合，无法叠加）。`
  },
  {id:16, name:"希罗·玛利亚", enName:"Hiro Maria", rarity:"UR", 
